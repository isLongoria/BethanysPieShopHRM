        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            for (int i = 1; i <= 1000; i++)
            {
                modelBuilder.Entity<TimeRegistration>().HasData(new TimeRegistration()
                {
                    ...
                    EmployeeId = 1,
                    StartTime = new DateTime(2024, 1, 1).AddDays(i + 300).AddHours(13).AddMinutes(41).AddSeconds(50),
                    EndTime = new DateTime(2024, 1, 1).AddDays(i + 300).AddHours(14).AddMinutes(54).AddSeconds(24),
